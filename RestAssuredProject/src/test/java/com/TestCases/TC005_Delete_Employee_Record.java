...
public class TC005_Delete_Employee_Record extends BaseClass
{
	...
	void deleteEmployee() throws InterruptedException
	{
		...
		// Get method will get all the id s from employee list
			// See == Capture id
		...
		//Capture id
			// now when we have all the employee list 
			// from there we pass the index value of the particular id to be deleted
			// here [0] index represents the 1st place
				// it may happen that when we pass the id directly it might not delete
				// hence we use this logic.
